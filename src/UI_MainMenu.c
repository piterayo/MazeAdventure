...
#define UI_MAINMENU_BUTTON_NEWGAME_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 30, (200-16-4-16-4-16-4-16-4-16)))

#define UI_MAINMENU_BUTTON_LOADGAME_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 30, (200-16-4-16-4-16-4-16)))

#define UI_MAINMENU_BUTTON_OPTIONS_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 30, (200-16-4-16-4-16)))

#define UI_MAINMENU_BUTTON_CREDITS_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 30, (200-16-4-16)))

#define UI_MAINMENU_BUTTON_EXIT_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 30, (200-16)))


#define UI_MAINMENU_BUTTON_NEWGAME_TEXT_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 32, (200-16-4-16-4-16-4-16-4-16+5)))

#define UI_MAINMENU_BUTTON_LOADGAME_TEXT_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 31, (200-16-4-16-4-16-4-16+5)))

#define UI_MAINMENU_BUTTON_OPTIONS_TEXT_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 33, (200-16-4-16-4-16+5)))

#define UI_MAINMENU_BUTTON_CREDITS_TEXT_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 33, (200-16-4-16+5)))

#define UI_MAINMENU_BUTTON_EXIT_TEXT_POSITION (cpctm_screenPtr((u16)CPCT_VMEM_START, 36, (200-16+5)))
